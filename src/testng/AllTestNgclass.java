...
public class AllTestNgclass {
	...
	public void beforeMethod() {
		System.out.println("beforemethod is run");
	}
	
	@AfterMethod
	public void afterMethod() {
		System.out.println("aftermethod is run");
	}
	...
	public void beforeSuite() {
		System.out.println("beforesuite  is run");
	}
	
	@AfterSuite
	public void afterSuite() {
		System.out.println("aftersuite  is run");
	}
	
	@BeforeGroups
	public void beforeGroups() {
		System.out.println("before group is run");
	}
...
*/
	...
	System.out.println("Before suite will always execute priore to all annotation or test in the suite  ");
	}
